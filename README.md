...
1. [项目概览](#项目概览)
2. [系统架构总览](#系统架构总览)
3. [架构决策记录 (ADR)](#架构决策记录-adr)
4. [核心特性矩阵](#核心特性矩阵)
5. [安装与环境准备](#安装与环境准备)
6. [快速上手](#快速上手)
7. [数据模型与 API](#数据模型与-api)
8. [存储格式与持久化](#存储格式与持久化)
9. [查询引擎与多语言接口](#查询引擎与多语言接口)
10. [事务、并发与容错机制](#事务并发与容错机制)
11. [索引体系与性能调优](#索引体系与性能调优)
12. [运维与治理工具](#运维与治理工具)
13. [监控、诊断与可观察性](#监控诊断与可观察性)
14. [集成模式与实践](#集成模式与实践)
15. [示例与学习资源](#示例与学习资源)
16. [安全、备份与合规](#安全备份与合规)
...
项目的关键技术决策记录在 `docs/architecture/` 目录下，采用 [ADR (Architecture Decision Records)](https://adr.github.io/) 标准格式：

| ADR                                                          | 标题           | 状态      | 说明                                             |
| ------------------------------------------------------------ | -------------- | --------- | ------------------------------------------------ |
| [ADR-001](docs/architecture/ADR-001-Tech-Stack.md)           | 技术栈选型     | ✅ 已接受 | TypeScript + Node.js ESM + pnpm 的选择理由与权衡 |
