...
| BETA-03R4     | [TCK] 重构后恢复推进（ReturnOrderBy2 → Wave2 余簇）         | High   | WIP    | codex/feat/TBETA-03-returnorderby2-fixes | 2026-02-13 已修复 ReturnOrderBy2、ReturnOrderBy6 场景5、WithOrderBy4 场景8、WithOrderBy1 场景21/22（跨类型排序 + NaN 匹配）以及 Return4 场景4/6/7/10（列名保留、空输入聚合、重复列名冲突）；下一步继续清理 Wave2 余簇 |
