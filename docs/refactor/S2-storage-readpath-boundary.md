...
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/engine.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/snapshot.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/api.rs`

### 3.2 可选新增

- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path/mod.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path/scanner.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path/materialize.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_overlay.rs`

## 4. 证据与前置

- engine 体量与复杂度高：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/engine.rs:1`
...
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/tests/t51_snapshot_scan.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/tests/m1_graph.rs`
- `/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/tests/t47_api_trait.rs`
...
1. 已完成切片-1（Snapshot 属性读取 helper 抽离）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_overlay.rs`。
...
3. 本轮验证通过
   - `cargo test -p nervusdb-storage read_path_overlay --lib`
...
4. 已完成切片-2（Snapshot 邻接迭代器重复逻辑收敛）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_neighbors.rs`。
   ...
   - 迭代器外部行为与签名保持不变。
5. 切片-2 验证通过
   - `cargo test -p nervusdb-storage read_path_neighbors --lib`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`

6. 已完成切片-3（邻接迭代器模块下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_iters.rs`。
...
7. 切片-3 验证通过
   - `cargo test -p nervusdb-storage --lib`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`

8. 已完成切片-4（属性值到 API 值转换下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_convert.rs`。
...
9. 切片-4 验证通过
   - `cargo test -p nervusdb-storage read_path_convert --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --lib`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
...
12. 已完成切片-6（节点 tombstone 判定 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_nodes.rs`。
...
13. 切片-6 验证通过
   - `cargo test -p nervusdb-storage read_path_nodes --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
14. 已完成切片-7（API 邻接迭代器适配器下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_api_iter.rs`。
...
15. 切片-7 验证通过
   - `cargo test -p nervusdb-storage read_path_api_iter --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
16. 已完成切片-8（标签解析 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_labels.rs`。
...
17. 切片-8 验证通过
   - `cargo test -p nervusdb-storage read_path_labels --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
18. 已完成切片-9（L0Run 属性判定 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_run_props.rs`。
...
19. 切片-9 验证通过
   - `cargo test -p nervusdb-storage read_path_run_props --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
20. 已完成切片-10（L0Run 状态判定 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_run_state.rs`。
...
21. 切片-10 验证通过
   - `cargo test -p nervusdb-storage read_path_run_state --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
22. 已完成切片-11（活节点迭代逻辑下沉）
   - 扩展模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_nodes.rs`。
...
24. 已完成切片-12（L0Run 边索引读取 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_run_edges.rs`。
...
25. 切片-12 验证通过
   - `cargo test -p nervusdb-storage read_path_run_edges --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
26. 已完成切片-13（L0Run 迭代器 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_run_iters.rs`。
...
27. 切片-13 验证通过
   - `cargo test -p nervusdb-storage read_path_run_iters --lib`（编译级红灯后转绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
28. 已完成切片-14（L0Run 属性桶读取 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_run_property_maps.rs`。
...
29. 切片-14 验证通过
   - `cargo test -p nervusdb-storage read_path_run_property_maps --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
30. 已完成切片-15（Label/RelType 符号解析路径收敛）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_symbols.rs`。
...
31. 切片-15 验证通过
   - `cargo test -p nervusdb-storage read_path_symbols --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t59_label_interning`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
32. 已完成切片-16（Snapshot 统计读取 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_stats.rs`。
...
33. 切片-16 验证通过
   - `cargo test -p nervusdb-storage read_path_stats --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `cargo test -p nervusdb --test t156_optimizer`
   - `bash scripts/workspace_quick_test.sh`

34. 已完成切片-17（GraphSnapshot 属性桥接 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_api_props.rs`。
...
35. 切片-17 验证通过
   - `cargo test -p nervusdb-storage read_path_api_props --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb --test t53_integration_storage`
   - `bash scripts/workspace_quick_test.sh`

36. 已完成切片-18（持久化属性树读取 helper 下沉 + api.rs 读路径收敛）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_property_store.rs`。
...
37. 切片-18 验证通过
   - `cargo test -p nervusdb-storage read_path_property_store --lib`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
38. 已完成切片-19（StorageSnapshot 统计计数路径收敛）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_api_stats.rs`。
   - 先补失败测试，再实现计数 helper：
...
39. 切片-19 验证通过
   - `cargo test -p nervusdb-storage read_path_api_stats --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
40. 已完成切片-20（Engine 读视图装配 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_engine_view.rs`。
   - 先补失败测试，再实现：
...
41. 切片-20 验证通过
   - `cargo test -p nervusdb-storage read_path_engine_view --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `cargo test -p nervusdb --test t106_checkpoint_on_close`
   - `bash scripts/workspace_quick_test.sh`

42. 已完成切片-21（GraphStore snapshot tombstone 收敛）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_tombstones.rs`。
...
43. 切片-21 验证通过
   - `cargo test -p nervusdb-storage read_path_tombstones --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
46. 已完成切片-23（Engine 标签读取 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_engine_labels.rs`。
   - 先补失败测试，再实现：
   ...
   - 对外接口行为保持不变。
47. 切片-23 验证通过
   - `cargo test -p nervusdb-storage read_path_engine_labels --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t59_label_interning`
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
48. 已完成切片-24（Engine IdMap 快照读取 helper 下沉）
   - 新增模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_engine_idmap.rs`。
...
49. 切片-24 验证通过
   - `cargo test -p nervusdb-storage read_path_engine_idmap --lib`（先红后绿）
   - `cargo test -p nervusdb-storage --test t47_api_trait`
   - `cargo test -p nervusdb-storage --test t51_snapshot_scan`
   - `cargo test -p nervusdb-storage --test m1_graph`
   - `bash scripts/workspace_quick_test.sh`
...
50. 已完成切片-25（Engine IdMap 读取入口进一步收敛）
   - 扩展模块：`/Volumes/WorkDrive/Code/github.com/LuQing-Studio/rust/nervusdb/nervusdb-storage/src/read_path_engine_idmap.rs`。
