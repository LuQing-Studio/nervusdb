...
| T43 | v2 M1：IDMap + MemTable + Snapshot（Log-Structured Graph） | L3 | P0 | Plan | feat/T43-v2-m1-idmap-memtable-snapshot | 实现 I2E 持久化（E2I 启动重建）、邻接 MemTable + tombstone、commit 冻结 L0Run、Snapshot 读隔离、WAL 扩展为图语义事件与 replay |
