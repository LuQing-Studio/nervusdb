...
```json
{
  ...
  "scripts": {
    ...
    "synapse:compact": "synapsedb auto-compact synapse/data/app.synapsedb --auto-gc"
  },
  "dependencies": {
    "synapsedb": "^1.1.0"
  }
...
const db = await SynapseDB.open('synapse/data/app.synapsedb', {
  enableLock: true,
...
const router = Router();
const dbPromise = SynapseDB.open('synapse/data/app.synapsedb');
...
- run: synapsedb stats synapse/data/app.synapsedb --summary
- run: pnpm test
```
