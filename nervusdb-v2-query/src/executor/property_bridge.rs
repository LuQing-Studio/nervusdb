...
pub(super) fn merge_storage_property_to_api(v: &PropertyValue) -> nervusdb_v2_api::PropertyValue {
    match v {
...
pub(super) fn api_property_map_to_storage(
    map: &BTreeMap<String, nervusdb_v2_api::PropertyValue>,
        ...
        let api_props = BTreeMap::from([(
            ...
            nervusdb_v2_api::PropertyValue::Map(BTreeMap::from([(
                ...
                nervusdb_v2_api::PropertyValue::List(vec![
                    ...
                    nervusdb_v2_api::PropertyValue::Int(1),
                ]),
            )])),
        )]);
